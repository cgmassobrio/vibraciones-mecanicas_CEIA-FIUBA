...
data_file = 'train_test_R.pt'

# Save files names
model_file = 'model_test_27.pt'
loss_file = 'loss_test_27.pt'
# coeficients_file = 'coef_test.pt'
fig_loss_file = 'loss_test_27.png'
# fig_coeficients_file = 'coeficients.png'
...
vib_model = Fit_inverse(param_data_path, param_model_path)
...
# Define optimizer
optimizer = optim.LBFGS(vib_model.model.parameters(), lr=0.1, max_iter=1, max_eval=50000, tolerance_change=1.0 * np.finfo(float).eps)
