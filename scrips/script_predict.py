...
# Save files names
fig_predict_file_W = 'predict_W_29.png'
fig_predict_file_W_3D = 'predict_W_3D_29.png'
# fig_error_file_W = 'error_W.png'
fig_predict_file_Psi = 'predict_Psi_29.png'
fig_predict_file_Psi_3D = 'predict_Psi_3D_29.png'
# fig_error_file_Psi = 'error_Psi.png'
...
fig_predict_path_W_3D = os.path.join(parent_dir, FIGURES_PATH, fig_predict_file_W_3D)
...
fig_predict_path_Psi_3D = os.path.join(parent_dir, FIGURES_PATH, fig_predict_file_Psi_3D)
...
model = Fit_model(param_data_path, param_model_path)
...
predict_plot.plot_predict3D(data_pred_dict_W, fig_predict_path_W_3D, level_cont=25, title='Predicción de desplazamiento W')

# Prediction plot Psi
data_pred_dict_Psi = {'input': A_cpu, 'output': Psi_pred_mesh}
predict_plot.plot_predict2D(data_pred_dict_Psi, fig_predict_path_Psi, level_cont=25, title='Predicción de rotaciones Psi')
predict_plot.plot_predict3D(data_pred_dict_Psi, fig_predict_path_Psi_3D, level_cont=25, title='Predicción de rotaciones Psi')
# Absolute error plot
